...
%GKENGINE_HOME%\tools\adb push %GKENGINE_HOME%/builds/%FOLDER_NAME%/paks mnt/sdcard/gkENGINE/paks/
%GKENGINE_HOME%\tools\adb shell ls mnt/sdcard/gkENGINE/paks

rem Step2 重新安装
%GKENGINE_HOME%\tools\adb install -r %GKENGINE_HOME%/builds/%FOLDER_NAME%/apk/gklauncher-debug.apk
