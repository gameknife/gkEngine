...
void frag_custom_per_light( inout fragPass pPass, inout fragLightPass pLight )
{
	...
	// Half Lambert
	float halfLambert = (pLight.fNdotL * 0.5) + 0.5;
	halfLambert = pow(halfLambert, g_SkinScatter);
	float3 cDiffuse = pLight.cDiffuse.xyz * halfLambert * (2 - 1 + pLight.fNdotL);                                            // 1 alu
