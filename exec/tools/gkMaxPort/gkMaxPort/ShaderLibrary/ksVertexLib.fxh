...
#ifdef _MAX_
	OUT.vTangent.xyz = mul(IN.vertCommon.vTangent.xyz, (float3x3)g_mWorld);
	OUT.vBinormal.xyz = mul(IN.vertCommon.vBinormal.xyz, (float3x3)g_mWorld);
	OUT.vNormal.xyz = mul(IN.vertCommon.vNormal.xyz, (float3x3)g_mWorld);
