...
HRESULT DXUTChangeDevice( DXUTDeviceSettings* pNewDeviceSettings, IDirect3DDevice9* pd3d9DeviceFromApp,
                          ID3D10Device* pd3d10DeviceFromApp, bool bForceRecreate, bool bClipWindowToSingleAdapter, bool autoResize = true );
...
HRESULT DXUTChangeDevice( DXUTDeviceSettings* pNewDeviceSettings,
                          IDirect3DDevice9* pd3d9DeviceFromApp, ID3D10Device* pd3d10DeviceFromApp,
                          bool bForceRecreate, bool bClipWindowToSingleAdapter,bool autoResize )
{
    HRESULT hr;
...
// 			nWindowWidth = nWindowWidth * 4 / 3;
// 			nWindowHeight = nWindowHeight * 4 / 3;
...
//--------------------------------------------------------------------------------------
HRESULT WINAPI DXUTReset3DEnvironment9()
{
    HRESULT hr;
...
//-----------------------------------------------------------------------
bool      WINAPI DXUTIsDeviceLost()
{
	return GetDXUTState().GetDeviceLost();
}
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
bool	  WINAPI DXUTChangeRenderSize( LONG width, LONG height )
{
	DXUTDeviceSettings* pOldDeviceSettings = GetDXUTState().GetCurrentDeviceSettings();
	pOldDeviceSettings->d3d9.pp.BackBufferWidth =width;
	pOldDeviceSettings->d3d9.pp.BackBufferHeight = height;
	return (DXUTChangeDevice(pOldDeviceSettings, NULL, NULL, false, false, false) == S_OK);
}
