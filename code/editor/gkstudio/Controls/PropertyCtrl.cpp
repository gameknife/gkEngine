...
CPropertyCtrl::CPropertyCtrl()
{
	...
	if( CTextureBrowserDialog::GetCurrentInstance() )
	{
		CTextureBrowserDialog::GetCurrentInstance()->SetTextureBrowserDoubleClickCallback( NULL );
	}
}
...
BOOL CPropertyCtrl::OnMouseWheel(UINT nFlags, short zDelta, CPoint pt)
{
	...
	//int pos = FlatSB_GetScrollPos( GetSafeHwnd(),SB_VERT );
